...
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Experimental/Apt/Xfce4/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Experimental/Apt/Xfce4/vncserver-stop -P /usr/local/bin/
rm -rf /etc/pulse/default.pa
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Experimental/Apt/Xfce4/default.pa -P /etc/pulse/
